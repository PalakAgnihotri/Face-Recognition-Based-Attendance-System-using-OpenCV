...
class FaceRecognition:
    def __init__(self, root):
        ...
        img1 = Image.open(r"C:\Users\agnih\OneDrive\Desktop\FaceRecognition\FaceRecognition\background\blog-–-462-1.webp")
    ...
    def face_recog(self):
        ...
        if not os.path.exists("classifier.xml"):
            print("Classifier file not found. Please check the path.")
            return
        ...
        while True:
            ...
            if elapsed_time > 5 or cv2.waitKey(1) == 13:  # Stop after 5 seconds or on Enter key press
                break
